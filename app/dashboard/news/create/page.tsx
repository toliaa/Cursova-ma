...
import { createNewsArticle } from "@/app/actions/news-actions"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Add a new news article to the website</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Article Details</CardTitle>
          <CardDescription>Enter the details for the new article</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
